...
//         console.log(gamepadAPI.axesStatus[1]*gamepadAPI.axesStatus[0]) //debugging
    ...
    class Network {
        ...
        mutateTowards(goals, inn = 0) {
            ...
            if (this.error1 < this.error2) {
                ...
                this.reversal = []
                console.log(this.error1,this.error2, "good")
            }
        }
    }
    class Data{
    ...
    class Imager {
        constructor(){
            this.circ = new Circle(10,10, 7, "blue")
            this.rect = new Rectangle(0,0,20,20,"white")
        }
        draw(){
            this.rect.draw()
            this.circ.draw()
    ...
    //     outt.push(0)
    // }
    // let perc = new Network(outt, [1600,1600])
    let net = new Network([0,0], [2,2])
